...
export const zh: Messages = {
  ...
  /* 命令面板                                                          */
  /* ---------------------------------------------------------------- */
  "palette.trigger": "搜索命令…",
  "palette.placeholder": "fetch、checkout、worktree、squash…",
  "palette.inputLabel": "搜索 GitCraque 命令",
  "palette.dialogLabel": "GitCraque 命令",
  "palette.hint.navigate": "导航",
  "palette.hint.run": "执行",
  "palette.hint.close": "关闭",
  "palette.empty": "没有命令匹配“{query}”。",
  ...
  "commands.group.remotes": "远程",
  "commands.group.appearance": "外观",

  "commands.repo.refresh": "重新加载仓库",
  "commands.repo.refresh.keywords": "刷新, 重载, 更新, refresh, reload",
  "commands.repo.open": "打开另一个仓库…",
  "commands.repo.open.keywords": "打开, 切换, 仓库, 项目, 文件夹, open, repo",
  "commands.repo.favorite": "打开 {name}",
  "commands.repo.favorite.missing": "{path} —— 未找到该文件夹",
  "commands.repo.favorite.keywords": "收藏, 项目, 打开, 切换",
  "commands.repo.favorite.gone": "{name} 已不在磁盘上",
  "commands.worktree.switch": "切换到工作树 {label}",
  "commands.worktree.keywords": "工作树, worktree, chdir",
  "commands.worktree.list": "在侧栏中查看工作树",
  "commands.worktree.list.hint_one": "已登记 {count} 个",
  "commands.worktree.list.hint_other": "已登记 {count} 个",
  "commands.branch.create": "创建分支",
  "commands.branch.create.keywords": "分支, 新建, branch",
  "commands.branch.checkout": "检出 {name}",
  "commands.branch.checkout.pinned": "被 {worktree} 占用",
  "commands.branch.checkout.keywords": "检出, checkout",
  "commands.branch.inUse": "{name} 已在使用中",
  "commands.branch.inUse.detail": "该分支已在 {worktree} 中检出。请切换工作树，而不是执行 checkout。",
  "commands.net.fetch": "Fetch --all --prune",
  "commands.net.fetch.keywords": "拉取, fetch",
  "commands.net.pull": "Pull",
  "commands.net.pull.keywords": "拉取, pull",
  "commands.net.pullRebase": "Pull --rebase",
  "commands.net.pullRebase.keywords": "拉取, 变基, pull, rebase",
  "commands.net.push": "Push…",
  "commands.net.push.keywords": "推送, push",
  "commands.stash.push": "储藏更改（stash）",
  "commands.stash.push.keywords": "储藏, stash",
  "commands.tag.create": "创建标签",
  "commands.tag.create.keywords": "标签, tag",
  "commands.stash.applyLatest": "应用 {ref}",
  "commands.stash.apply.keywords": "储藏, 应用, stash, apply",
  "commands.history.squash": "压缩选中的 {count} 个提交",
  "commands.history.squash.needs": "压缩选区（请选择 2 个或更多）",
  "commands.history.squash.keywords": "压缩, 合并, squash, rebase",
  "commands.remote.add": "添加 Origin",
  "commands.remote.add.keywords": "远程, origin, 添加",
  "commands.remote.browse": "在浏览器中打开 {name}",
  "commands.remote.browse.keywords": "远程, 打开, 浏览器",
  "commands.theme.light": "浅色主题",
  "commands.theme.dark": "深色主题",
  "commands.theme.keywords": "主题, 深色, 浅色, theme",
  "commands.language.set": "语言：{name}",
  "commands.language.keywords": "语言, 界面语言, language, locale, i18n",
