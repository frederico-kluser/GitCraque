...
const MESSAGES = {
  en: {
    ...
    "error.noPendingOperation": "there is no operation in progress to resolve",
    "error.noConflicts": "the pending operation has no conflicted files",
  ...
  pt: {
    ...
    "error.noPendingOperation": "não há operação em curso para resolver",
    "error.noConflicts": "a operação pendente não tem arquivo em conflito",
  ...
  es: {
    ...
    "error.noPendingOperation": "no hay ninguna operación en curso que resolver",
    "error.noConflicts": "la operación pendiente no tiene archivos en conflicto",
  ...
  zh: {
    ...
    "error.noPendingOperation": "没有正在进行的操作可以解决",
    "error.noConflicts": "待处理的操作没有冲突文件",
